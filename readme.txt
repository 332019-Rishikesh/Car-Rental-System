...
```
git clone https://github.com/332019-Rishikesh/Car-Rental-System.git
```
...
note : http://localhost:8000 this is localhost backend, to setup & running backend: <a href='https://github.com/332019-Rishikesh/Car-Rental-System.git'>click here</a>
